...
if (empty($itens)) {
    registrarErro($_SESSION["cliente_id"], $_SESSION["id"], pegarRotaUsuario(), "Nenhum item encontrado para esta venda. ID: " . $venda_id, 1, pegarIpUsuario(), pegarNavegadorUsuario());
}
