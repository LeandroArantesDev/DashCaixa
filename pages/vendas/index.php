            ...
            <div class="tabela-form lg:w-4/6 bg-fundo-interface h-full">
                ...
                <div class="h-full flex-1 overflow-y-auto pb-6">
                    <div class="h-max flex flex-col gap-3 p-3 pb-20">
                        ...
                        $stmt = $conexao->prepare("SELECT id, nome, categoria_id, img, preco, estoque
                    FROM produtos
                    WHERE cliente_id = ?
                    AND status = 0
                    AND categoria_id IN (
                    ...
                    ");
                        ...
                        if ($resultado->num_rows > 0) :
                            while ($row = $resultado->fetch_assoc()) :
                                ?>
                                <div class="produto-card flex items-center gap-4 p-4 border border-borda rounded-lg hover:shadow-sm transition-all duration-200 hover:scale-102 <?= ($row["estoque"] < 1) ? "filter grayscale" : "" ?>">
                                    <div class="img-container">
                                        ...
                                        <?php else: ?>
                                            <img src="../../assets/img/placeholder_produto.jpg"
                                    ...
                                    <button id="btn-add-produto"
                                            type="button" <?= ($row["estoque"] < 1) ? "disabled" : "" ?>
