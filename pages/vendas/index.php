...
<div class="conteudo">
    ...
    <div class="flex gap-3 items-center justify-between h-[75dvh] w-full">
        <div class="tabela-form w-4/6 bg-white h-full">
            <h2 class="text-lg font-bold p-4">Buscar produtos</h2>
        ...
        <div class="w-2/6 bg-white border-l border-gray-200 rounded-lg" id="carrinho-lateral">
            <div class="flex w-full border-b border-[var(--cinza-borda)] gap-4 p-4 justify-between items-center">
                <h2><i class="bi bi-cart"></i> Produtos Selecionados</h2>
                <button type="button" id="limpar-carrinho" title="Limpar carrinho" class="hidden">
