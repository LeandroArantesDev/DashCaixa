...
<header class="flex justify-between px-5 h-15 border-b border-gray-300/80">
    ...
    <div class="flex gap-3 items-center justify-center group">
        ...
        <div id="user-opcoes"
            class="fixed right-5 top-13 bg-white flex flex-col shadow-lg border border-gray-300/80 rounded-xl invisible opacity-0  group-hover:visible group-hover:opacity-100">
