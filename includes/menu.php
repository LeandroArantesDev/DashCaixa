...
if (isset($_SESSION['id'])):
    ?>
    <div id="overlay-mobile" class="invisible fixed top-0 left-0 bg-black/30 w-full h-full lg:hidden z-900"
         onclick="toggleMenu()"></div>
    <aside id="menu"
           class="fixed -right-full top-0 h-full min-w-[80%] lg:min-w-70 border-r border-borda/80 p-4 bg-fundo-interface lg:static lg:top-auto lg:right-auto z-1000">
